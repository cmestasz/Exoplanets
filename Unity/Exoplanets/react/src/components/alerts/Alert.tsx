...
export default function Alert({
  ...
  return (
    <view
      className={clsx(
        'absolute top-0 right-0 rounded-md border-2 max-w-80 p-3 shadow-lg z-50 flex flex-row gap-2 m-1.5 text-2xl font-exo duration-800 transition-all enter:-trans-y-[120%] enter:scale-90 enter:opacity-0  enter:state-duration-0 state-duration-800 leave:-trans-y-[120%] leave:opacity-0 leave:scale-90 m-duration-700 m-ease-out',
        {
